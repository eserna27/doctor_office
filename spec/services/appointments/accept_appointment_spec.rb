...
module Appointments
  RSpec.describe "Accept appointment" do
    def store(records)
    ...
    def accept_appointment(appointment_id, confidencial_id, appointment_store)
      Appointments.accept(appointment_id, confidencial_id, appointment_store)
    end
    ...
    it "updates the record" do
      expect(appointment_store).to receive(:update).with(appointment_id, {status: :accepted})
      accept_appointment(appointment_id, confidencial_id, appointment_store)
    end

    it "returns success" do
      status = accept_appointment(appointment_id, confidencial_id, appointment_store)
